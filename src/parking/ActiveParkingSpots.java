...
public class ActiveParkingSpots {
	...
	public static void all() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ActiveParkingSpots window = new ActiveParkingSpots();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("ACTIVE PARKING SPOTS");
		...
		try {
			...
			PreparedStatement stmt = con.prepareStatement("select * from parking");
